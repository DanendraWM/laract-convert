...
# nama_file=f'excel/Animax SEA Sep EPG'
...
for x in range(1, count_rows):
    ...
    start_time=sh.cell_value(rowx=x, colx=1)
    end_time=sh.cell_value(rowx=durasi, colx=1) if durasi < count_rows else f"{end_date} 00:00:00"
